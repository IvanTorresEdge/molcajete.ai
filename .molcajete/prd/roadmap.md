...
**Focus Areas:**
- **Setup command** - Interactive plugin configuration to streamline onboarding [IN DEVELOPMENT - 35% complete (Phase 1/5 done) - See .molcajete/prd/specs/20251114-molcajete_setup_command/tasks.md]
